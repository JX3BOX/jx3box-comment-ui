...
// CONCATENATED MODULE: ./src/Comment.vue?vue&type=template&id=2b872b18&
...
var avatarvue_type_template_id_d1889cce_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/avatar.vue?vue&type=template&id=d1889cce&
...
var component = normalizeComponent(
  ...
  avatarvue_type_template_id_d1889cce_render,
  avatarvue_type_template_id_d1889cce_staticRenderFns,
  false,
  null,
  null,
  null
...
var comment_content_simple_component = normalizeComponent(
  ...
  comment_content_simplevue_type_template_id_118e75ee_render,
  comment_content_simplevue_type_template_id_118e75ee_staticRenderFns,
  false,
  null,
  null,
  null
...
var reply_list_component = normalizeComponent(
  ...
  reply_listvue_type_template_id_201d176e_render,
  reply_listvue_type_template_id_201d176e_staticRenderFns,
  false,
  null,
  null,
  null
...
var comment_with_reply_component = normalizeComponent(
  ...
  comment_with_replyvue_type_template_id_0cfc0fe8_render,
  comment_with_replyvue_type_template_id_0cfc0fe8_staticRenderFns,
  false,
  null,
  null,
  null
  ...
  methods: {
    ...
    onSubmit() {
      POST(`/api/post/${this.postId}/comment`, null, {
        ...
        if (this.pager.index == this.pager.pageTotal || this.pager.total % this.pager.pageSize == 0) {
          this.reloadCommentList(this.pager.index);
        }
      }).catch(() => {});
    }
